...
class Stage9IntegrationStabilityTests(unittest.TestCase):
    ...
    def test_grc_stage9_controls_blocks_and_connections(self):
        ...
        self.assertIn("integration_time_s", blocks["integration_time_s"]["parameters"]["value"])
        self.assertIn("1.0", blocks["integration_time_s"]["parameters"]["value"])
        ...
        self.assertIn("phase_rate_fit_window_s", blocks["phase_rate_fit_window_s"]["parameters"]["value"])
        self.assertIn("60.0", blocks["phase_rate_fit_window_s"]["parameters"]["value"])
        self.assertIn("coherence_target_pct", blocks["coherence_target_pct"]["parameters"]["value"])
        self.assertIn("95.0", blocks["coherence_target_pct"]["parameters"]["value"])
