...
2. From the repository root, inspect the GRC file:
   ...
   ```bash
   sed -n '1,240p' grc/fx_interferometer_v1_stage1_3.grc
   ```
...
5. Confirm the generated top block is named `fx_interferometer_v1_stage1_3`.
...
4. Generate Python from the flowgraph:
   ...
   ```bash
   grcc grc/fx_interferometer_v1_stage1_3.grc
   ```
